hack_main_data_adjusted <- function(main_data = main_data,
                           meta = meta,
                           global_run = TRUE,
  ...
  suppressMessages({
    ...
    jags_list <- readRDS(here::here(file.path(main_path, "jags_list.rds")))
    
    
    fit <- readRDS(here::here(file.path(main_path, "fit.rds")))
    
    #saves inside the function
    estimates <- readRDS(here::here(file.path(main_path, "estimates.rds")))
